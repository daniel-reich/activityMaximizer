...
public class AddChallange extends Fragment implements View.OnClickListener {
    ...
    LinearLayout lay_hastimefalse,lay_hastimetrue;
...
//        HomeActivity.title.setText("");
        ...
        lay_hastimefalse=(LinearLayout)view.findViewById(R.id.lay_hastimefalse);
        lay_hastimetrue=(LinearLayout)view.findViewById(R.id.lay_hastimetrue);
...
//
        cb_appoint_set.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b) {
                    iv_appoint_set.setVisibility(View.VISIBLE);
                    map.put("Appointments Set", true);
                }
                else {
                    iv_appoint_set.setVisibility(View.GONE);
        ...
        cb_close_iba.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b){
                    iv_close_iba.setVisibility(View.VISIBLE);
                    map.put("Closed IBA",true);
                }
                else {
                    iv_close_iba.setVisibility(View.GONE);
                    map.put("Closed IBA", false);
                }
            }
        });
        cb_close_life.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b) {
                    iv_close_life.setVisibility(View.VISIBLE);
                    map.put("Closed Life", true);
                }
                else {
                    iv_close_life.setVisibility(View.GONE);
                    map.put("Closed Life", false);
                }
            }
        });
        cb_close_other_bus.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(b) {
                    iv_close_other_bus.setVisibility(View.VISIBLE);
                    map.put("Closed Other Business", true);
                }
                else {
                    iv_close_other_bus.setVisibility(View.GONE);
                    map.put("Closed Other Business", false);
                }
            }
        });
        cb_contactsadded.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    iv_contactsadded.setVisibility(View.VISIBLE);
                    map.put("Contacts Added", true);
                } else {
                    iv_contactsadded.setVisibility(View.GONE);
        ...
        cb_totalprem.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    iv_totalprem.setVisibility(View.VISIBLE);
                    map.put("Total Premium", true);
                } else {
                    iv_totalprem.setVisibility(View.GONE);
                    map.put("Total Premium", false);
                }
            }
        });
        cb_went_on_kt.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if (b) {
                    iv_went_on_kt.setVisibility(View.VISIBLE);
                    map.put("Went on KT", true);
                } else {
                    iv_went_on_kt.setVisibility(View.GONE);
...
//            tv.setText(formattedDate);
    ...
    public void updatefield(){
        ...
        boolean totprem=false,closebus=false,cont_add=false,app_set=false,went_kt = false,cls_life=false,cls_iba=false;
...
//        map.put("Went on KT",false);
        ...
        Log.e("appointment_set",map.get("Appointments Set").toString());

        app_set= (boolean) map.get("Appointments Set");
        cls_iba=(boolean)map.get("Closed IBA");
        cls_life=(boolean)map.get("Closed Life");
        closebus=(boolean)map.get("Closed Other Business");
        cont_add=(boolean)map.get("Contacts Added");
        totprem=(boolean)map.get("Total Premium");
        went_kt=(boolean)map.get("Went on KT");
        ...
        if(tv_totalprem1.getText().toString().equals("0")&tv_close_other_bus1.getText().toString().equals("0")&
                ...
                tv_close_iba1.getText().toString().equals("0")&app_set&cls_iba&cls_life&closebus&
                cont_add&totprem&went_kt){
        ...
        if(lay_hastimetrue.getVisibility()==View.VISIBLE)
            newUserData.put("hasTimeLimit",true);
        else
...
//                        edit.putString("filter_enddate", tv.getText().toString());
    ...
    public void onClick(View v) {
        ...
        if(v.getId()==R.id.tv_settitle){
            ...
            if(lay_date.getVisibility()==View.VISIBLE) {
                setdata();
                lay_hastimetrue.setVisibility(View.GONE);
                lay_hastimefalse.setVisibility(View.VISIBLE);
                lay_date.setVisibility(View.GONE);
            }
            else {
                setdata();
                lay_hastimefalse.setVisibility(View.GONE);
                lay_hastimetrue.setVisibility(View.VISIBLE);
    ...
    public void setdata(){
        ...
        tv_totalprem1.setText("0");
        tv_contactsadded1.setText("0");
        tv_appoint_set1.setText("0");
        tv_went_on_kt1.setText("0");
        tv_close_life1.setText("0");
        tv_close_iba1.setText("0");
        tv_close_other_bus1.setText("0");
