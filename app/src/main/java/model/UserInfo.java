...
public class UserInfo {
    ...
    public String achievements,contactsAdded,  created, dailyPointAverages,fivePointClients,fivePointRecruits,
    ...
    public UserInfo(String givenName, String familyName, String phoneNumber, String email, String uid,
                    String achievements, String contactsAdded, String created, String dailyPointAverages,
                    ...
                    String solution_number, String state, String trainer_solution_number, String upline_solution_number) {
